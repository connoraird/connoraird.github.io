...
The Parallel Fortran Unit Testing Framework (pFUnit) is a framework for unit
testing Fortran.
...
{{< include ../_code_examples/pfunit_code_example.qmd >}}

## The preprocessor {.smaller}
...
- Directives exist for the following tasks
  ...
  - Specifying assertions.
    - The [documentation](https://pfunit.sourceforge.net/page_Assert.html) needs
      some work.
    - I had a PR merged to begin improvements
