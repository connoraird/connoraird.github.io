...
See my [github profile](https://github.com/schochastics) for a comprehensive
...
tibble::tribble(
    ...
    c(
      "Enabled the OpenMP and CUDA backends of Trilinos (an external library utilised by MUSIC)",
      "Produced scripts to automate the building of Trilinos, music and Kokkos-tools.",
      "Wrote submission scripts to allow the rapid production of benchmark data.",
      "Profiled MUSIC using the NVIDIA NSIGHT system."
    ),
) |>
